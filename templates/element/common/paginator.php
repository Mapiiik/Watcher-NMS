 ...
 * draws it, which is why nothing here asks the caller what to translate against. A plugin keeps a
 * pager of its own for the same reason: its wording belongs to its own catalogue.
 *
