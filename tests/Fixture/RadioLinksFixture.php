 ...
 * RadioLinksFixture
 */
class RadioLinksFixture extends TestFixture
{
    /**
     * Fields
     *
    ...
    public $fields = [
        ...
        'distance' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
        'authorization_number' => ['type' => 'string', 'length' => null, 'default' => null, 'null' => true, 'collate' => null, 'comment' => null, 'precision' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 'a9f1e0d2-2591-4fbc-849a-3c4620b7d0f5',
