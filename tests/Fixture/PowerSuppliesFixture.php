...
class PowerSuppliesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'battery_duration' => ['type' => 'float', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => 'a474521f-7160-4fdb-8f63-2531741e3703',
                'name' => 'Lorem ipsum dolor sit amet',
                'power_supply_type_id' => 'afec34b9-9479-4bb7-9c00-6d6cdfb73221',
                'access_point_id' => '8aaac5b0-c1c6-4e9c-8415-7d68b41d8220',
                'serial_number' => 'Lorem ipsum dolor sit amet',
                'battery_count' => 1,
                'battery_voltage' => 1,
                'battery_capacity' => 1,
                'battery_replacement' => '2020-03-24',
                'battery_duration' => 1,
