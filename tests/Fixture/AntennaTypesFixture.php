...
class AntennaTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'radio_unit_band_id' => ['type' => 'uuid', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null],
        'manufacturer_id' => ['type' => 'uuid', 'length' => null, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null],
        'antenna_gain' => ['type' => 'integer', 'length' => 10, 'default' => null, 'null' => true, 'comment' => null, 'precision' => null, 'unsigned' => null, 'autoIncrement' => null],
    ...
    public function init(): void
    {
        $this->records = [
            [
                'id' => '4651d3e6-aab2-44e3-9e36-210b100e96e9',
                'name' => 'Lorem ipsum dolor sit amet',
                'radio_unit_band_id' => 'ad019c72-22e7-4a23-b1cc-1dc86e961caa',
                'manufacturer_id' => '3903080d-7282-4d38-8384-4ae596829a08',
                'antenna_gain' => 1,
