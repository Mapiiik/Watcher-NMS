...
class SettingsControllerTest extends TestCase
{
     ...
     *
     * The other way round from the test above: a block nothing links to can only be opened by
     * typing its path into the address bar. The blocks are read the way the service reads them,
     * so a block added to the application or to a plugin has to be linked before this passes
     * again.
     *
     * @return void
     */
    ...
    public static function blocksProvider(): array
    {
        return [
            ...
            'access points' => ['core.access_points'],
