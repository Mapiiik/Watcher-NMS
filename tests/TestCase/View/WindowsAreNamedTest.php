...
class WindowsAreNamedTest extends TestCase
{
    ...
    public function testAPageIsCalledWhatItCallsItself(): void
    {
        ...
        $this->assertStringEndsWith('| Manufacturers', $listing);
        $this->assertStringEndsWith('| Add Manufacturer', $form);
    }
    ...
    {
        $this->assertSame('Access Point Types | View', $this->fallbackFor('AccessPointTypes', 'view'));
        $this->assertSame('Routeros Devices | Index', $this->fallbackFor('RouterosDevices', 'index'));
    }
