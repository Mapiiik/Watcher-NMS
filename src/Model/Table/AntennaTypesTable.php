 ...
 * @method \App\Model\Entity\AntennaType findOrCreate($search, callable|array|null $callback = null, $options = [])
 ...
 * @method iterable<\App\Model\Entity\AntennaType>|false saveMany(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\AntennaType> saveManyOrFail(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\AntennaType>|false deleteMany(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\AntennaType> deleteManyOrFail(iterable $entities, $options = [])
