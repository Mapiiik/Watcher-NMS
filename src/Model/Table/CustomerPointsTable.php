 ...
 * @method \App\Model\Entity\CustomerPoint findOrCreate($search, callable|array|null $callback = null, $options = [])
 * @method \App\Model\Entity\CustomerPoint findOrNewEntity($search)
