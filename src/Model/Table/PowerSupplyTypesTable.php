 ...
 * @method \App\Model\Entity\PowerSupplyType findOrCreate($search, callable|array|null $callback = null, $options = [])
 ...
 * @method iterable<\App\Model\Entity\PowerSupplyType>|false saveMany(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\PowerSupplyType> saveManyOrFail(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\PowerSupplyType>|false deleteMany(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\PowerSupplyType> deleteManyOrFail(iterable $entities, $options = [])
