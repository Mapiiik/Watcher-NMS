 ...
 * @method \App\Model\Entity\Manufacturer findOrCreate($search, callable|array|null $callback = null, $options = [])
 ...
 * @method iterable<\App\Model\Entity\Manufacturer>|false saveMany(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\Manufacturer> saveManyOrFail(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\Manufacturer>|false deleteMany(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\Manufacturer> deleteManyOrFail(iterable $entities, $options = [])
