 ...
 * @method \App\Model\Entity\RouterosDeviceIp findOrCreate($search, callable|array|null $callback = null, $options = [])
 ...
 * @method iterable<\App\Model\Entity\RouterosDeviceIp>|false saveMany(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\RouterosDeviceIp> saveManyOrFail(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\RouterosDeviceIp>|false deleteMany(iterable $entities, $options = [])
 * @method iterable<\App\Model\Entity\RouterosDeviceIp> deleteManyOrFail(iterable $entities, $options = [])
