...
class AccessPointsController extends AppController
{
    ...
    public function view($id = null)
    {
        $accessPoint = $this->AccessPoints->get($id, [
            'contain' => ['AccessPointContacts', 'PowerSupplies' => ['PowerSupplyTypes'], 'RadioUnits' => ['RadioUnitTypes', 'RadioLinks', 'AntennaTypes'], 'RouterosDevices' => ['DeviceTypes']],
        ]);
    ...
    public function map()
    {
        ...
        */            $content .= '</ul>';
            ...
            $mapMarkers[] = ['lat' => $customerPoint->gps_y, 'lng' => $customerPoint->gps_x, 'title' => $customerPoint->name, 'content' => $content, 'iconSet' => 'green'];
        }
