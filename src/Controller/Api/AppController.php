 ...
 * not before it. The endpoint the agent posts to shows the shape - a token in an `Authorization`
 * header, `FormProtection` taken off the controller's event manager, and the prefix named in the
 * CSRF middleware's skip callback.
 *
