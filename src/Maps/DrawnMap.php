...
{
    /**
     * @param array<string, \App\Maps\Marker> $markers What is marked, keyed by what it marks.
     * @param array<string, \App\Maps\Polyline> $polylines The lines, keyed by the ends they join.
     */
