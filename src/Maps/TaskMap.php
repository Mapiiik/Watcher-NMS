...
final class TaskMap
{
     ...
     *
     * The number heads it, the state stands beside it, and the summary says where the task is and
     * how to reach whoever is there - the same line the listing carries. The beginning of the text
     * follows, for the ones that carry one.
     */
