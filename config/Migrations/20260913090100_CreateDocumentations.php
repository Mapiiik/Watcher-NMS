 ...
 *
 * A folder hangs on an access point. Which of them a kind of folder has to carry is its type's to say, so every one of
...
class CreateDocumentations extends BaseMigration
{
    ...
    public function up(): void
    {
        ...
        $this->table('documentations', ['id' => false, 'primary_key' => ['id']])
            ...
            ->addIndex(['access_point_id', 'happened_on'])
